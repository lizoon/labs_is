...
from ghost_methods.a_star import AStar
from ghost_methods.greedy import Greedy
import ghost_methods.maze_ascii_convert
...
gameBoard = copy.deepcopy(ghost_methods.maze_ascii_convert.convert_from_ascii(heuristic_maze_gen.generate_map()))
spriteRatio = 3 / 2
